...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = -937756822L;
    ...
    public final EnumPath<base.domain.post.constants.BoardType> boardType = createEnum("boardType", base.domain.post.constants.BoardType.class);
